...
#include <strai/api/static_check.h>
...
class TaskCaller {
 public:
  ...
  TaskCaller(StraiRuntime *runtime, RemoteFunctionHolder remote_function_holder);
  ...
  TaskCaller &SetRuntimeEnv(const strai::RuntimeEnv &runtime_env) {
...
template <typename F>
TaskCaller<F>::TaskCaller(StraiRuntime *runtime,
