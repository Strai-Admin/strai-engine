...
#include "strai/common/asio/asio_util.h"
#include "strai/core_worker/store_provider/memory_store/memory_store.h"

namespace strai {
namespace internal {

using strai::core::CoreWorkerMemoryStore;

class LocalModeObjectStore : public ObjectStore {
 public:
  explicit LocalModeObjectStore(LocalModeStraiRuntime &local_mode_strai_tuntime);
 ...
 private:
  ...
  LocalModeStraiRuntime &local_mode_strai_tuntime_;
};
