...
class ObjectStore {
 public:
  ...
  ///
  /// \param[in] ids The object id arstrai which should be got.
  /// \param[in] timeout_ms The maximum wait time in milliseconds.
  /// \return shared pointer arstrai of the result buffer.
  ...
  ///
  /// \param[in] ids The object id arstrai which should be waited.
