...
TEST(SerializationTest, TypeHybridTest) {
  ...
  // 1 arg
  // marshall
  msgpack::sbuffer buffer1 = strai::internal::Serializer::Serialize(in_arg1);
  // unmarshall
  out_arg1 =
      strai::internal::Serializer::Deserialize<uint32_t>(buffer1.data(), buffer1.size());
  ...
  msgpack::sbuffer buffer2 =
      strai::internal::Serializer::Serialize(std::make_tuple(in_arg1, in_arg2));

  // unmarshall
  std::tie(out_arg1, out_arg2) =
      strai::internal::Serializer::Deserialize<std::tuple<uint32_t, std::string>>(
...
// TODO(Larry Lian) Adapt on windows
#ifndef _WIN32
  // Test std::any
  msgpack::sbuffer buffer3 = strai::internal::Serializer::Serialize(std::make_tuple(
      in_arg1, in_arg2, in_arg3, in_arg4, in_arg5, in_arg6, in_arg7, in_arg8));

  std::vector<std::any> result =
      strai::internal::Serializer::Deserialize<std::vector<std::any>>(buffer3.data(),
                                                                    buffer3.size());
  ...
  msgpack::sbuffer buffer4 = strai::internal::Serializer::Serialize(result);

  std::vector<std::any> result_2 =
      strai::internal::Serializer::Deserialize<std::vector<std::any>>(buffer4.data(),
                                                                    buffer4.size());
...
TEST(SerializationTest, BoundaryValueTest) {
  ...
  msgpack::sbuffer buffer1 = strai::internal::Serializer::Serialize(in_arg1);
  out_arg1 =
      strai::internal::Serializer::Deserialize<std::string>(buffer1.data(), buffer1.size());
  EXPECT_EQ(in_arg1, out_arg1);

  std::vector<std::byte> in_arg2, out_arg2;
  msgpack::sbuffer buffer2 = strai::internal::Serializer::Serialize(in_arg2);
  out_arg2 = strai::internal::Serializer::Deserialize<std::vector<std::byte>>(
      buffer1.data(), buffer1.size());
  EXPECT_EQ(in_arg2, out_arg2);

  char *in_arg3 = nullptr;
  msgpack::sbuffer buffer3 = strai::internal::Serializer::Serialize(in_arg3, 0);
  auto out_arg3 = strai::internal::Serializer::Deserialize<std::vector<std::byte>>(
      buffer1.data(), buffer1.size());
