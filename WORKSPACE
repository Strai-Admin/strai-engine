workspace(name = "com_github_strai_project_strai")
...
load("//bazel:strai_deps_setup.bzl", "strai_deps_setup")

strai_deps_setup()

load("//bazel:strai_deps_build_all.bzl", "strai_deps_build_all")

strai_deps_build_all()

# This needs to be run after grpc_deps() in strai_deps_build_all() to make
