...
def auto_http_archive(
    ...
    # auto appending strai project namespace prefix for 3rd party library reusing.
    if build_file == True:
        build_file = "@com_github_strai_project_strai//%s:%s" % ("bazel", "BUILD." + name)
...
def strai_deps_setup():
    # Explicitly bring in protobuf dependency to work around
    # https://github.com/strai-project/strai/issues/14117
    ...
    # all of http/git_repository should add prefix for patches defined in strai directory.
    auto_http_archive(
        name = "com_github_antirez_redis",
        build_file = "@com_github_strai_project_strai//bazel:BUILD.redis",
        patch_args = ["-p1"],
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:redis-quiet.patch",
        ],
    ...
    auto_http_archive(
        ...
        build_file = "@com_github_strai_project_strai//bazel:BUILD.hiredis",
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:hiredis-windows-msvc.patch",
        ],
    )

    auto_http_archive(
        name = "com_github_spdlog",
        build_file = "@com_github_strai_project_strai//bazel:BUILD.spdlog",
    ...
    auto_http_archive(
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:opencensus-cpp-harvest-interval.patch",
            "@com_github_strai_project_strai//thirdparty/patches:opencensus-cpp-shutdown-api.patch",
        ],
        patch_args = ["-p1"],
    )
    ...
    auto_http_archive(
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:prometheus-windows-headers.patch",
            # https://github.com/jupp0r/prometheus-cpp/pull/225
            "@com_github_strai_project_strai//thirdparty/patches:prometheus-windows-zlib.patch",
            "@com_github_strai_project_strai//thirdparty/patches:prometheus-windows-pollfd.patch",
        ],
    )
    ...
    auto_http_archive(
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:grpc-cython-copts.patch",
        ],
    )
    ...
    # This can be different from the protobuf version that Strai core uses internally.
    ...
    # protobuf library that Strai supports.
    http_archive(
    ...
    auto_http_archive(
        ...
        patches = [
            "@com_github_strai_project_strai//thirdparty/patches:msgpack-windows-iovec.patch",
        ],
    )
    ...
    http_archive(
        ...
        build_file = "@com_github_strai_project_strai//bazel:BUILD.nlohmann_json",
    )
    ...
    http_archive(
        ...
        build_file = "@com_github_strai_project_strai//bazel:BUILD.jemalloc",
