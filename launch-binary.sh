...
REPO="strai-official/strai_launch_binaries"

INSTALL_DIR="/usr/local/bin"
BINARY_NAME="strai-io-launcher"
...
download_binary() {
  case "$(uname -sm)" in
    "Darwin arm64") FILENAME="strai_io_launch_binary_mac" ;;
    "Linux x86_64") FILENAME="strai_io_launch_binary_linux" ;;
